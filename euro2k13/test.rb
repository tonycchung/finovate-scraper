...
url = "http://www.finovate.com/europe13vid/bbva.html"
nokogiri_page = Nokogiri::HTML(open("#{url}"))
company_details = nokogiri_page.css('#contentwrapper > table > tr > td > table:nth-child(3) > tr > td > table > tr > td:nth-child(2)').inner_html
...
within(:xpath, '//table/tbody/tr/td/table[2]/tbody/tr/td/div/table/tbody/tr/td[1]') do
  ...
  all(:xpath, './/p').each do |p|
    ...
    contacts = nokogiri_page.xpath("//table/tr/td/table[2]/tr/td/div/table/tr/td[1]/p[#{count}]").inner_html if p.match /Contact Information/i
